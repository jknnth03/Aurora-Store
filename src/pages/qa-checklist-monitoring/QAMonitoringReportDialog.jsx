...
import AttachmentViewerDialog from "../qa-checklist/AttachmentViewerDialog";
import ViewSignatureDialog from "../qa-checklist/ViewSignatureDialog";
import "../qa-checklist/QAReportDialog.scss";
...
const QAMonitoringReportDialog = ({ open, onClose, entry, storeName }) => {
  ...
  const activeAttachmentPath = entry?.attachment_path ?? null;
                ...
                <div className="qar__sidebar">
                  <div className="qar__sidebar-card">
                    ...
                    <div className="qar__sidebar-details">
                      ...
                      <p>
                        <span className="qar__detail-label">Time Summary:</span>{" "}
                        <span className="qar__detail-value">
                          {getTimeDiff()}
                        </span>
                      </p>
                      ...
                      <p>
                        ...
                        <span className="qar__detail-value">{staffNames}</span>
                      </p>
                      <p>
...
export default QAMonitoringReportDialog;
